...
async function main() {
  ...
  await ensureColumns(db, "users", [
    ...
    ["account_status", "ENUM('active','suspended','disabled') NOT NULL DEFAULT 'active' AFTER reseller_status"],
    ["session_version", "INT NOT NULL DEFAULT 0 AFTER account_status"],
    ["last_login_at", "TIMESTAMP NULL AFTER session_version"],
  ...
  await db.query(`CREATE TABLE IF NOT EXISTS hero_slides (
    id INT AUTO_INCREMENT PRIMARY KEY,
    image_data LONGBLOB NOT NULL,
    image_mime VARCHAR(100) NOT NULL,
