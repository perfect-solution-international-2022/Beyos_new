        ...
        {steps.map((step, index) => {
          ...
          return (
            <li key={step} className="relative flex flex-col items-center text-center">
              ...
              <span className={`relative z-10 flex h-8 w-8 items-center justify-center rounded-full border-2 text-xs font-bold ${complete || active ? "border-brand-600 bg-brand-600 text-white" : "border-navy-800/15 bg-white text-navy-800/45"}`}>
                {complete ? "✓" : index + 1}
              </span>
