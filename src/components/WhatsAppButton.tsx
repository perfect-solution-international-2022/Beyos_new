...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`fixed right-4 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] text-white shadow-[0_8px_28px_rgba(15,37,64,0.25)] ring-4 ring-white transition hover:scale-105 hover:bg-[#1fbd5a] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-navy-800/30 sm:right-6 lg:bottom-6 ${isProduct ? "bottom-[calc(11rem+env(safe-area-inset-bottom))]" : "bottom-[calc(6.5rem+env(safe-area-inset-bottom))]"}`}
    >
      <svg
        aria-hidden="true"
        viewBox="0 0 32 32"
