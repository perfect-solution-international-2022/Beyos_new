  ...
  },
  {
    ...
    items: [
      { label: "Orders", icon: "cart", children: [
        ...
        { label: "Pending Delivering", href: "/admin/orders/delivering" },
...
function NavIcon({ name }: { name: string }) {
  ...
  const paths: Record<string, React.ReactNode> = {
    ...
    receipt: (<><path d="M4 2h16v20l-3-2-2 2-2-2-2 2-2-2-2 2-3-2Z" /><line x1="8" y1="7" x2="16" y2="7" /><line x1="8" y1="11" x2="16" y2="11" /><line x1="8" y1="15" x2="12" y2="15" /></>),
